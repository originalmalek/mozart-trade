...
def amend_order(symbol, order_id, category='linear'):
...
def trading_stop(symbol, sl_price, sl_size, tpsl_mode='Full',category='linear',
					   position_idx=0):
...
def trading_tp(symbol, tp_price, tp_size, tpsl_mode='Partial',category='linear',
					   position_idx=0):
	return session.set_trading_stop(
		category=category,
		symbol=symbol,
